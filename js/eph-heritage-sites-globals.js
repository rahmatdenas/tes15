...
`SELECT DISTINCT ?siteQid ?siteLabel ?designationQid ?p131LokasiLabel ?tahunBerdiriMentah ?tahunPresisi WHERE {
  ...
  # === TAHAP 2: PENYETEMPELAN 19 KAB/KOTA ===
  ...
  # === TAHAP 3: DATA OPSIONAL LOKASI SPESIFIK (DIPERBAIKI) ===
  OPTIONAL { 
    ?site wdt:P131 ?p131Lokasi . 
    # FILTER ANTI-GANDA: Buang jika isinya Provinsi atau Kab/Kota itu sendiri
    FILTER (?p131Lokasi != wd:Q2772) 
    FILTER (?p131Lokasi != ?designation)
  }
